...
let summa = item_3 + " " + item_4
//console.log (summa)

let multyply = item_3 * item_4
//console.log ("multyply =" + multyply, typeof("multyply =" + multyply))
...
//console.log("__" + "item_6==", item_6, "item_6_type ==", typeof item_6_type + "--")
